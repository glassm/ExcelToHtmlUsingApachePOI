...
public class Converter {
    ...
    public Converter(Workbook wb, Appendable output) {
        if (wb == null) {
    ...
    public void convertXlsToHtml(String sourcePath, String destPath) throws IOException {
        Converter Converter = create(sourcePath, new PrintWriter(new FileWriter(destPath)));
     ...
     */
    public static Converter create(Workbook wb, Appendable output) {
        return new Converter(wb, output);
    }
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static Converter create(String path, Appendable output)
            throws IOException {
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static Converter create(InputStream in, Appendable output)
            throws IOException {
